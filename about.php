      ...
      <div class="heading">
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <h1>About</h1>
              <p class="mb-0">Me apasiona transformar ideas en aplicaciones útiles. Con experiencia en desarrollo web y móvil, combino diseño, lógica y rendimiento para ofrecer productos que realmente funcionan. Siempre aprendiendo algo nuevo y listo para nuevos retos.</p>
            </div>
          </div>
        </div>
      </div>
